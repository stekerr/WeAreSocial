...
EMAIL_HOST_USER = 'stephenjameskerrigan@gmail.com'
EMAIL_PORT = 587
...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_test_ypi0xPLf2tV17BHLlYfxPrXj')
STRIPE_SECRET = os.getenv('STRIPE_SECRET', 'sk_test_3xv0YppGbXNosyAirVWQUUPR')